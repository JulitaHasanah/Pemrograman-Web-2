            ...
            <div class="col-md-5 border rounded mt-2">
                <form action="<?php echo e(route('karyawan.store')); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pasword_input" name="paswordInput">
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restoran\resources\views/tambahKaryawan.blade.php ENDPATH**/ ?>